package com.jiajia.framelibrary.indicator;
...
public class TrackIndicatorView extends HorizontalScrollView {
     ...
     * 5.设置适配器
     */
    public void setAdapter(IndicatorAdapter adapter, ViewPager2 viewPager) {
     ...
     * 5.设置适配器
     */
    public void setAdapter(IndicatorAdapter adapter, ViewPager2 viewPager, boolean smoothScroll) {
